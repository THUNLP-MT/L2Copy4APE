...
def _evaluate(eval_fn, input_fn, decode_fn, path, config):
    ...
    with graph.as_default():
        ...
        placeholders = {
            ...
            "tagging": tf.placeholder(tf.int32, [None, None], "tagging"),
            "source_pos": tf.placeholder(tf.int32, [None, None], "source_pos"),
            "origin_length": tf.placeholder(tf.int32, [None], "origin_length"),
        ...
        with tf.train.MonitoredSession(session_creator=sess_creator) as sess:
            while not sess.should_stop():
                ...
                outputs = sess.run(predictions, feed_dict={
                    ...
                    placeholders["tagging"]: feats["tagging"],
                    placeholders["source_pos"]: feats["source_pos"],
                    placeholders["source_length"]: feats["source_length"],
                    placeholders["origin_length"]: feats["origin_length"],
                })
                # shape: [batch, len]
